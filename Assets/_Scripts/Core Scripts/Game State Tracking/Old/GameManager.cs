...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private MissionStatusUI missionStatus;
    ...
    //     missionStatus.ChangeMissionPrompt("Go to speak to the neighbor.");
    // }

    // public void ConfirmResettingDadsComputer()
    // {
    //     gameStateData.hasResetDadsComputer = true;
    //     missionStatus.ChangeMissionPrompt("Like an subscribe!!");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Dad wanted to ask for something.");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Go find the butterfly tree branch.");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Go back to the neighbor bring her the butterfly tree branch.");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Rembember dad needed you with the computer.");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Find something for the cat to eat! like tuna!");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Find the cat to give it tuna!");
    // }
    ...
    //     missionStatus.ChangeMissionPrompt("Oh right, the butterfly tree.");
    // }
